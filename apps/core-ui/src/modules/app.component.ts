...
export class AppComponent implements OnInit, OnDestroy {
  ...
  public ngOnDestroy(): void {
    ...
    if (
      this._hookPageBodyUpdateEventSubscription &&
      !this._hookPageBodyUpdateEventSubscription.closed
    ) {
      this._hookPageBodyUpdateEventSubscription.unsubscribe();
    }

    if (
      this._hookSideBarDisplayMessageSubscription &&
      !this._hookSideBarDisplayMessageSubscription.closed
    ) {
