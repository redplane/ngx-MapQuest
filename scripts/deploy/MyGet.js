...
const {LIBRARY_FOLDER_NAME, copyAsync, executeAsync, getLibraryFolderPath} = require('../common');
...
function deploy() {
  ...
  console.log(`Copied ${process.env.NPMRC_MYGET_NGX_MAPQUEST} to ${distFolder}`);
