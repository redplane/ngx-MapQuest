export type MQ_NAVIGATION_CONTROL_POSITION =
  | 'topleft'
  | 'topright'
  | 'bottomleft'
  | 'bottomright';
...
export type MQ_TEXT_MARKER_POSITION = 'right' | 'left' | 'top' | 'bottom';
export type MQ_TEXT_MARKER_ICON_TYPE = 'marker' | 'via' | 'circle';
export type MQ_MARKER_ICON_SIZE = 'sm' | 'md' | 'lg';
