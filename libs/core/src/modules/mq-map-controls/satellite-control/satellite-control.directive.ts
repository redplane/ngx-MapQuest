...
@Directive({
  ...
  selector: 'mq-map mq-control-satellite',
})
export class SatelliteControlDirective implements OnInit, OnDestroy {
  //#region Properties

  private _options: SatelliteControlOptions;
  ...
  public get options(): SatelliteControlOptions {
    return this._options;
  }

  @Input()
  public set options(value: SatelliteControlOptions) {
  ...
  public constructor(
    protected readonly mqMap: MqMapComponent,
  ...
  public ngOnInit(): void {
    const hookMapLoadedEventSubscription =
      this.mqMapService.mapLoadedEvent.subscribe((mapControl) => {
