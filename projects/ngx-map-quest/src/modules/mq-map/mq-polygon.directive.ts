...
import {LatLngExpression, LeafletEvent, LeafletMouseEvent, PolylineOptions} from 'leaflet';
...
export class MqPolygonDirective implements OnInit, OnDestroy {
  ...
  private _points: LatLngExpression[] | LatLngExpression[][] | LatLngExpression[][][];
  ...
  private _updateInstanceSubject: Subject<{ property: POLYGON_PROPERTY, value: any }>;
  ...
  // Points in the polygon
  @Input()
  public set points(value: LatLngExpression[] | LatLngExpression[][] | LatLngExpression[][][]) {
    this._points = cloneDeep(value);
  }

  public get points(): LatLngExpression[] | LatLngExpression[][] | LatLngExpression[][][] {
    return this._points;
  }
  ...
  public constructor(protected readonly polygonService: MqPolygonService,
                     protected readonly mqMapService: MqMapService,
                     protected readonly mapComponent: MqMapComponent) {
    this._uuid = uuid();

    this._updateInstanceSubject = new Subject<{ property: POLYGON_PROPERTY, value: any }>();
