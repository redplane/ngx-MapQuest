...
import {CircleMarker, CircleMarkerOptions, LatLngExpression, LeafletEvent, LeafletMouseEvent} from 'leaflet';
...
export class MqCircleDirective implements OnInit, OnDestroy {
  ...
  private _updateInstanceSubject: Subject<{ property: CIRCLE_PROPERTY, value: any }>;
  ...
  public constructor(protected readonly circleService: MqCircleService,
                     protected readonly mqMapService: MqMapService,
                     protected readonly mapComponent: MqMapComponent) {
    this._uuid = uuid();

    this._updateInstanceSubject = new Subject<{ property: CIRCLE_PROPERTY, value: any }>();
